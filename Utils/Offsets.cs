...
public abstract class Offsets
{
    ...
    public static int dwSensitivity_sensitivity;
    ...
    public static async Task UpdateOffsets()
    {
        try
        {
            var sourceDataDw = JsonConvert.DeserializeObject<OffsetsDTO>(
                await FetchJson("https://raw.githubusercontent.com/sj-mm-xm/test/main/offsets.json"));
            var sourceDataClient = JsonConvert.DeserializeObject<ClientDllDTO>(
                await FetchJson("https://raw.githubusercontent.com/sj-mm-xm/test/main/client.dll.json"));
            ...
            destData.dwSensitivity = sourceDataDw.clientdll.dwSensitivity;
            destData.dwSensitivity_sensitivity = sourceDataDw.clientdll.dwSensitivity_sensitivity;
            ...
            destData.m_AimPunchCache = 0x14F0;
            ...
            destData.m_aimPunchAngle = 0x14CC;
    ...
    {
        dwSensitivity = data.dwSensitivity;
        dwSensitivity_sensitivity = data.dwSensitivity_sensitivity;
